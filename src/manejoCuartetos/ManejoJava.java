...
public class ManejoJava {
    ...
    public void manejoOr(ObjetosJAVA jv, ArrayList<ArrayList<Nodo>> pilaCuarpeta, ArrayList<Nodo> ladoA, ArrayList<Nodo> ladoB, int jerarquia) {
        if (SintaxJAVA.inst) {
    ...
    public void segundoChequeoIf(ObjetosJAVA jv, ArrayList<ArrayList<Nodo>> pilaCuarpeta, ArrayList<ArrayList<Nodo>> pilaFalsas, int jerarquia){
    ...
    public void retornoWhile(ObjetosJAVA jv, ArrayList<ArrayList<Nodo>> pilaCuarpeta, ArrayList<ArrayList<Nodo>> pilaFalsas,  int jerarquia){
        ManejoCondiciones manejo = new ManejoCondiciones();
        String etWhile = buscarUltimoWhile(jv, jerarquia);
        jv.getCuarpeta().add(new Nodo("GOTO", null, null, etWhile, jerarquia));
        segundoChequeoIf(jv, pilaCuarpeta, pilaFalsas, jerarquia);
    ...
    public void agregarCondicionWhile(ObjetosJAVA jv, ArrayList<Nodo> booleano, ArrayList<ArrayList<Nodo>> pilaCuarpeta, ArrayList<ArrayList<Nodo>> pilaFalsas, int jerarquia){
        ManejoCondiciones manejo = new ManejoCondiciones();
        String etWhile = buscarUltimoWhile(jv, jerarquia);
        primerChequeoIf(jv, booleano);
    ...
    public void retornoFor(ObjetosJAVA jv, ArrayList<ArrayList<Nodo>> pilaFor, String id, ArrayList<ArrayList<Nodo>> pilaCuarpeta, ArrayList<ArrayList<Nodo>> pilaFalsas, String varAsignar, int jerarquia){
        ManejoCondiciones manejo = new ManejoCondiciones();
